...
11. Tag the approved commit as `hardware-vX.Y.Z` and retain the package externally.
12. Inspect and document the first article before approving repeat builds.
